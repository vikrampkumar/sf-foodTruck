...
/**
 * Top level web response class, wraps the actual result and contains a holder for possible errors.
 * 
...
public class WebResponse<T extends Object> {
    ...
    public static class Errors implements Serializable {
         ...
         * @param messageSource The message source for interpolation.
         * @param locale The locale which the messages should be translated to.
         */
