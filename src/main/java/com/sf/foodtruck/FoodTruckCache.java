...
import com.sf.foodtruck.domain.FoodTruckCacheKey;
import com.sf.foodtruck.utils.GeoDistanceCalculatorUtil;
import com.sf.foodtruck.utils.JSONUtils;
...
public final class FoodTruckCache {
	 ...
	 * 
	 * @param foodTruckJson Collection of food trucks information.
	 */
	...
	/**
	 * Used for building up the food truck cache map with the specified collection of food trucks.
	 * 
	 * @param foodTruckCollection collection of food trucks.
	 */
	...
	public static Collection<FoodTruck> getFoodTruckNearLocation(final double latitude, final double longitude) {
		final FoodTruckCacheKey cacheKey = createFoodTruckCacheKey(latitude, longitude);
